...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        JavaCoin genesis = new JavaCoin("0");
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);

        //testing
        JavaCoin block1 = new JavaCoin(genesis.hash);
        ...
        JavaCoin block2 = new JavaCoin(block1.hash);
        ...
        JavaCoin block3 = new JavaCoin(block2.hash);
    ...
    public static void addBlock(JavaCoin newBlock) {
